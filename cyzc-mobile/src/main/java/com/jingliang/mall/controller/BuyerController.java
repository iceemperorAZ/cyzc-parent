...
public class BuyerController {
    ...
    public MallResult<String> analysisPhone() {
       return MallResult.buildQueryOk("厨亿直采服务协议\n" +
               "\n" +
               "本《厨亿直采服务协议》(下称“协议”)是您与上海晶粮贸易有限公司(下称“厨亿直采”)的经营者之间就厨亿直采服务等相关事宜所订立的契约。\n" +
               "厨亿直采软件包括厨亿直采小程序等(以下合称“本站”)。请您在使用厨亿直采产品或者服务前仔细阅读本用户协议，特别是免除或限制您责任的条款以及争议解决条款等，在充分理解并同意后使用相关产品或者服务。如您不同意本协议或隐私政策中任何条款的约定，您应立即停止注册、使用厨亿直采的软件和服务。旦您开始使用厨亿直采任何产品或者服务，即表示您已充分理解并同意本用户协议的全部内容，本用户协议即成为您与厨亿直采间具有约束力的法律文件。\n" +
               ...
               "用户在注册成为厨亿直采用户时提供的信息应真实完整、有效，并保证厨亿直采移动应用平台可以通过该信息与用户本人进行联系。同时，用户应在相关资料发生变更时及时更新注册信息。在成功注册后，厨亿直采会为每位用户开通一个账户，用于已注册用户登录厨亿直采并享受该平台服务，用户应妥善保管该账户的用户名和密码，并对在其账户下发生的所有活动承担责任。已注册用户登录厨亿直采并享受该平台服务，用户应妥善保管该账户的用户名和密码，并对在其账户下发生的所有活动承担责任。\n" +
               ...
               "二．商品交易\n" +
               "1.商品信息\n" +
               "厨亿直采标示的商品价格、数量、是否有货等商品信息根据实际情况随时都有可能发生变动，本站不作特别通知。由于厨亿直采上商品信息的数量极其庞大，本平台将会尽最大努力保证用户所购线上商品与对应实体门店公布的价格一致，但价目表和声明并不构成要约。厨亿直采有权在发现线上标示的产品信息存在明显错误或已生成的订单处于缺货状态的情况下单方面予以修改或取消该订单。但由于众所周知的网络技术因素等客观原因导致的线上信息滞后或差错的，希望用户对此情形予以理解。为表述便利，商品和服务简称为“商品”或“货物”。\n" +
               "2.商品促销\n" +
               ...
               "3.商品订单\n" +
               "厨亿直采保留对产品订购数量的限制权。在提交订单的同时，用户也同时承认了其拥有购买这些产品的权利能力和行为能力，并且对订单中提供的所有信息的真实性负责。由于市场变化等因素的影响，厨亿直采无法保证用户提交的订单商品都会有货；如用户拟购买的商品发生缺货，则厨亿直采有权取消订单，此种情形用户下单行为并不视为双方买卖合同关系成立。\n" +
               "4.商品提货\n" +
               "商品提货仅适用于用户所订购的厨亿直采商品，厨亿直采将在您指定的门店进行备货。所有在厨亿直采界面上标示的订单状态为参考状态，供用户参照使用。参考状态的计算是根据库存状况、正常的处理过程的基础上估计得出的。如用户需变更提货时间，应在厨亿直采通过客服电话及时通知；如果用户需他人代领商品(不建议代领)请让代领人出示“其他支付凭证”，由于“其他支付凭证”是领商品的必要凭证，请妥善保管“其他支付凭证”，否则，用户自行承担货物被假冒代领的法律风险与损失。\n" +
               "5.商品售后\n" +
               "用户在小程序交易后发生的售后问题，适用此规则。厨亿直采将通过系统通知、页面信息提示、短信或电话等方式向用户发送与售后处理相关的提示或通知，构成售后处理依据及结论的有效组成部分。\n" +
               "5.1售后受理时效\n" +
               "(1)用户下单后，厨亿直采如发现库存不足时，应及时告知用户并及时向用户退款。\n" +
               "(2)不支持无理由退换货的商品发生质量问题或错漏发时应在收到商品之时起请及时提出退换货申请。\n" +
               "(3)实行国家“三包政策”的商品如出现国家法律规定的功能性障碍或质量问题，支持消费者有权利在三包期间，商品损坏的时候要求商家免费修理或者换新的服务。\n" +
               "(4)超出本规则规定的售后时限发起的退换货申请无法受理。\n" +
               "5.2售后受理范围\n" +
               "（1）当用户购买的商品发生质量问题、商品错发/漏发商品破损、过期、描述不符等问题，支持退换货申请。\n" +
               ...
               "B、用户已提供相关凭证，厨亿直采将通过合理解释或提供厂家的经销凭证、报关单据(进口商品)、产品合格证、执行标准等相关凭证以证明商品来源或出厂合规。\n" +
               "C、若确认出售的商品为质量问题，提供退货退款服务；若确认出售的商品系假冒商品，用户基于生活消费所需购买的，提供退货退款服务(生活消费所需的认定：厨亿直采将依照普通人的认知水准及日常经验判断，或基于概率学和大数据技术，从交易主体、交易信息、交易行为等多个维度进行排查、综合判断用户是否属生活消费所需购买。)\n" +
               "(3)用户应保管申请退换货的商品，如有必要，厨亿直采将联系用户上门取回商品后进行退货退款处理。\n" +
               "5.2.2描述不符问题处理规范\n" +
               "(1)用户申请售后的商品存在描述不当系肉眼可识别的，用户应提供凭证予以证明，用户无法提供凭证的，不支持退换货。用户已提供凭证，厨亿直采针对用户给出的凭证确认描述不符属实的，不提供退货退款服务。\n" +
               ...
               "5.3附则\n" +
               "(1)厨亿直采将根据相关法律法规、市场情况、业务规则对本规则进行不定期修改、完善，并将通过厨亿直采小程序在适当位置予以展示。\n" +
               "(2)本规则生效或变更后尚未处理完结的交易，适用生效或变更后的规则。\n" +
               "6.积分部分\n" +
               "用户在厨亿直采注册时即生效为厨亿直采普通会员，参照《厨亿直采会员权益》积分规则享受积分优惠。\n" +
               "三、合作伙伴\n" +
               "厨亿直采只选择信誉良好的餐饮公司或本身即是上海晶粮贸易有限公司特约商户的公司为合作伙伴(以下简称合作伙伴),当用户通过厨亿直采获得合作伙伴的优惠服务时，请事先详阅优惠细则，因用户与合作伙伴产生的任何交易、服务发生纠纷时，应由用户与该合作伙伴自行协商解决，厨亿直采不承担任何责任。\n" +
               "厨亿直采第三方场景使用，以下或简称“第三方场景使用功能”,是指在您同意本协议的前提下，您可以在第三方服务商的APP、手机厂商系统的软硬件(以下简称“第三方场景”)内使用厨亿直采消费购物功能及服务。在开通第三方场景使用功能之前，您应当注意以下事项并承诺：您有意愿在第三方场景中使用厨亿直采购物车服务；同意第三方场景提供方将相关信息提供、同步给厨亿直采或厨亿直采将相关信息提供、同步绐第三方场景提供方；您认可第三方场景的软硬件安全管控机制，将按照其与您的协议约定履行用户安全注意义务。\n" +
               ...
               "(3)可在厨亿直采客户端注销厨亿直采帐号，注销后您将无法在第三方场景中查看、使用厨亿直采购物功能、查询订单信息或开具发票。\n" +
               ...
               "(2)第三方场景软硬件的技术、系统、网络等方面的稳定性，可能会造成您使用购物服务时，出现页面迟延、信息同步不及时或无法使用的情况，请您耐心等待或在厨亿直采客户端内使用购物服务。第三方场景使用功能实现以厨亿直采与第三方服务商的合作为基础，若厨亿直采与第三方服务商终止合作，第三方场景使用功能将自动终止。厨亿直采可以视第三方场景使用的用户体验情况，对产品功能进行升级、迭代更新或终止、下线。\n" +
               "四、用户权利与义务\n" +
               "用户有权拥有其在厨亿直采的用户名及密码，并有权使用自己的用户名及密码随时登录厨亿直采，同时用户可以使用用户信息通过厨亿直采客服中心进行购买行为。用户不得以任何形式转让或授权他人使用自己的厨亿直采用户名，否则由此产生的一切后果由用户自行承担。\n" +
               "用户有权根据本协议的规定以及厨亿直采上发布的相关规则在厨亿直采上查询商品信息、发表使用体验、参与商品讨论、邀请关注好友、合法上传商品图片、发表社区言论等参加厨亿直采的有关活动以及有权享受厨亿直采提供的其它的有关信息服务。\n" +
               ...
               "六、隐私保护\n" +
               "厨亿直采注重保护用户的个人信息及个人隐私。一旦完成厨亿直采的注册动作，您的注册信息即受到本用户协议保护。厨亿直采不会向任何无关第三方提供、出售出租、分享或交易您的个人信息，除非事先得到您的许可。但是，厨亿直采可能会向合作伙伴等第三方共享你的个人信息，以保障为您提供的服务顺利完成，并且改善和向用户提供更好的服务，但厨亿直采仅限于合法、正当、必要、特定、明确的目的共享您的个人信息。厨亿直采的合作伙伴为商品和技术服务供应商，厨亿直采可能会将与您的个人信息有关的用户数据共享给支持厨亿直采功能的的第三方进行分析和优化；这些支持包括为厨亿直采提供商品推荐、优化厨亿直采铺货策略等。同时，您应当遵守法律法规并谨慎合理地使用和妥善保管厨亿直采账号及密码，并对本人专属之账号和密码项下所有行为和事件负责，当用户发现厨亿直采账号被未经其授权的第三方使用或存在其他账号安全问题时应立即通知上海晶粮贸易有限公司，要求暂停该账号的服务，并向公安机关报案。上海晶粮贸易有限公司有权在合理时间内对用户的该类请求采取行动，但对采取行动前用户已经遭受的损失不承担任何责任。\n" +
               "隐私保护的适用范围：\n" +
               "1.在您注册厨亿直采账户时，您根据厨亿直采要求提供的个人注册信息。\n" +
               ...
               "5.1您在使用厨亿直采提供的搜索服务时输入的关键字信息。\n" +
               "5.2厨亿直采收集到您在本应用进行交易的有关数据，包括但不限于成交信息及评价详情。\n" +
               "5.3信用评价、违反法律规定或违反厨亿直采规则行为及厨亿直采已对您采取的措施。\n" +
               "七、厨亿直采用户协议的变更、终止、责任限制\n" +
               "1.协议的变更\n" +
               ...
               "2.协议的终止\n" +
               "用户认可，厨亿直采可以不经通知而自行决定终止全部或部分服务，包括终止用户的会员资格。即使厨亿直采没有要求或强制您严格遵守这些条款，也并不构成对属于厨亿直采的任何权利的放弃。如果用户在厨亿直采的客户账户被关闭，那么该用户也将丧失会员资格，对此，用户无权对厨亿直采主张任何权利或赔偿、补偿。\n" +
               "3.协议的责任限制\n" +
               "除了厨亿直采的使用条件中规定的其它限制和除外情况之外，在中国法律法规所允许的限度內，对于因会员制而引起的或与之有关的任何直接的、间接的、特殊的、附带的、后果性的或恁罚性的损害，或任何其它性质的损害，厨亿直采、上海晶粮贸易有限公司及其关联公司、分支机构的董事、管理人员、雇员、代理或其它代表在任何情况下都不承担责任。\n" +
               "八、服务的中断和终止\n" +
               "用户认可，厨亿直采有权随时修改或中断服务而不需通知用户，且不需对用户或任何第三方承担任何负责。用户对本协议的修改有异议，或对厨亿直采的服务不满，可以行使如下权利：\n" +
               "(1)停止使用厨亿直采的网络服务；\n" +
