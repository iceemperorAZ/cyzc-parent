...
public class ProductTypeResp implements Serializable {
     ...
     * 商品图片字符串转集合
     */
    public void setProductTypeImgUrlList(String productTypeImgUrl) {
        this.productTypeImgUrl = StringUtils.isBlank(productTypeImgUrl) ? null : Arrays.asList(productTypeImgUrl.split(";"));
    }
