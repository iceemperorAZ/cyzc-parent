...
public interface Constant {
    ...
    List<String> offlineOrderExcelTitle = Lists.newArrayList("商铺名称","客户姓名","客户电话","商品名称","商品规格","单位","数量","单价(单位：分)","总价(单位：分)","省","市","区/县","客户地址","客户要求送货日期和时间","业务员Id","业务员姓名","业务员工号","业务员电话","备注","是否可用","创建时间","开具发票进度","发票类型","单位名称","纳税人识别码","注册地址","注册电话","开户银行","银行账户","联系人","联系电话","快递地址");
    List<String> buyerExcelTitle = Lists.newArrayList("主键ID", "手机号", "注册时间");
    String EXEMPTION = "厨亿直采服务协议\n" +
            "\n" +
